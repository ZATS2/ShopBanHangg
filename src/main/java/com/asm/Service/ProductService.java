...
public interface ProductService {
	...
	Page<Product> searchProductByKY(String keywords, org.springframework.data.domain.Pageable pageable);
	
	Page<Product> findProductBetweenPrices(Double min, Double max, org.springframework.data.domain.Pageable pageable);
